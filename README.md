...
│   │   ├── test.json          # Тестовое продуктовое событие
...
#### Прошу дать совет по вопросам:
- какие параметры теста лучше заложить для данного проекта (пиковая нагрузка?)
- какие результаты и в каком виде лучше их отразить  
- нужно ли добавлять с какими параметрами виртуальной машины проводилось тестирование
- нужно ли дать анализ проведенного теста